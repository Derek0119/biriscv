...
#(
    ...
    ,parameter NUM_BTB_ENTRIES  = 512   //128 //影响所有分支/跳转指令
    ,parameter NUM_BTB_ENTRIES_W = 9    //7

    ,parameter BHT_ENABLE       = 1
    ,parameter NUM_BHT_ENTRIES  = 512  //主要影响条件分支跳转
    ,parameter NUM_BHT_ENTRIES_W = 9

    ,parameter RAS_ENABLE       = 1
    ,parameter NUM_RAS_ENTRIES  = 8  //主要影响ret、call指令
